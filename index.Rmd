...
$X_i \sim \mathrm{N}(\mu_1, \sigma_1^2)$

$Y_j \sim \mathrm{N}(\mu_2, \sigma_2^2)$
...
```{r anova-polynomial-data2, echo = FALSE, fig.width = 8}
plot(x, y, main = "Data", col = "red")
```
...
```{r anova-polynomial-data3, echo = FALSE, fig.width = 8}
plot(x, y, main = "Data", col = "red")
```
...
```{r anova-polynomial-fits3, echo = FALSE, fig.width = 8}
matplot(xx1, pp1, type = "l", lwd = 2, ylim = range(y), col = c(1, 3, 3),
        xlab = "x", ylab = "y", main = "Model fits")
plotCI(xx0, pp0[, "fit"],
       li = pp0[, "lwr"],
...
How prevalent is the 'true model myth' amongst students?  
